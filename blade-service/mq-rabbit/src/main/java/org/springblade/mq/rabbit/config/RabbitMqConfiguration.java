package org.springblade.mq.rabbit.config;
...
public class RabbitMqConfiguration {
	 ...
	 */
	@Bean
	public Queue directPreprocessPureSupPerson() {
		return new Queue(RabbitConstant.DIRECT_MODE_QUEUE_PREPROCESS_PURE_SUP_PERSON);
	}
